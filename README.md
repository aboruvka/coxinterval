### coxinterval: An R package for Cox-type models with interval-censored data
...
1. Install the `r-base-dev` package. For further details, see the [R download directory](http://cran.r-project.org/bin/linux/) documentation relevant to your Linux distribution.
...
##### Overriding defaults for custom CPLEX installations
